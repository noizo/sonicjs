...
- `/api/content/check-slug` — slug uniqueness check (great for admin UIs)
...
- **`name`** is what shows up in the URL — `/api/collections/blog_posts/content`. Stick to snake_case.
